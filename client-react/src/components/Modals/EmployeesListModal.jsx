        ...
        <ModalBody>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                background: view === 'list' ? 'rgba(67,233,123,0.25)' : 'rgba(255,255,255,0.1)',
                border: `1px solid ${view === 'list' ? 'rgba(67,233,123,0.5)' : 'rgba(255,255,255,0.2)'}`,
                borderRadius: '8px',
                padding: '8px 16px',
                color: view === 'list' ? '#43e97b' : '#ffffff',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
            ...
            <button
              ...
              style={{
                background: view === 'calendar' ? 'rgba(67,233,123,0.25)' : 'rgba(255,255,255,0.1)',
                border: `1px solid ${view === 'calendar' ? 'rgba(67,233,123,0.5)' : 'rgba(255,255,255,0.2)'}`,
                borderRadius: '8px',
                padding: '8px 16px',
                color: view === 'calendar' ? '#43e97b' : '#ffffff',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
